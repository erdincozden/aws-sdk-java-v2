...
public final class UnmarshallerRegistry {
    ...
    private final Map<MarshallLocation, Map<MarshallingType, XmlUnmarshaller<?>>> unmarshallers;
    ...
    public <T> XmlUnmarshaller<Object> getUnmarshaller(MarshallLocation marshallLocation, MarshallingType<T> marshallingType) {
        return (XmlUnmarshaller<Object>) unmarshallers.get(marshallLocation).get(marshallingType);
    }
    ...
    public static final class Builder {
        ...
        private final Map<MarshallLocation, Map<MarshallingType, XmlUnmarshaller<?>>> unmarshallers = new HashMap<>();
