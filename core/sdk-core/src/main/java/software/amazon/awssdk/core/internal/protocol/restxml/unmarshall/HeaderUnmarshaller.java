...
public final class HeaderUnmarshaller {
    ...
    public static final XmlUnmarshaller<Instant> INSTANT = new SimpleHeaderUnmarshaller<>(StringToValueConverter.TO_INSTANT);
    public static final XmlUnmarshaller<Float> FLOAT = new SimpleHeaderUnmarshaller<>(StringToValueConverter.TO_FLOAT);

    public static final XmlUnmarshaller<Map> MAP = ((context, field) -> {
